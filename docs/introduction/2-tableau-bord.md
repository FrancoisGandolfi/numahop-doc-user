...
- Vérification des **pré-rejets/pré-validations** : [_Validation ou rejet des documents_](/docs/utilisateur/Contrôles/controles-manuels.md#35-validation-ou-rejet-du-document) <Icon icon={["fa", "arrow-up-right-from-square"]} />.

...
Dans cette partie, vous pouvez faire un mapping entre votre code de langue utilisé dans NumaHOP pour votre Dublin Core (ex ISO 639-2) et le code attendu par le CINES exprimé en ISO 639-3. Ajouter autant de correspondance que nécessaire à l'aide de l'icône <Icon icon={["fa", "plus"]} />

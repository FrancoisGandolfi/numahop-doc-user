...
Guide pratique pour déposer des documents sur le ftp

Déposer des documents sur le ftp
Ouvrir FileZilla et se connecter au ftp NumaHOP avec les identifiants présents dans NumaHOp>
paramètres> configurations FTP

Déposer des documents sur le ftp
- dans l’écran de gauche se positionner sur les documents à envoyer sur le ftp
- dans l’écran de droite allez jusqu’au bon répertoire, ici :
/disk/data-sciencespo/sftp/sciencespo/sciencespo

Déposer des documents sur le ftp
créer le répertoire dans lequel déposer les documents
NB : les documents à livrer doivent être dans un dossier portant le même identifiant

Déposer des documents sur le ftp
- sélectionner tous les documents à envoyer
- faire un clic droit et choisir Envoyer

Déposer des documents sur le ftp
on peut suivre le bon envoi des documents dans la partie basse de l’écran

Déposer des documents sur le ftp

A la fin la liste doit être la même sur les 2 parties de l’écran